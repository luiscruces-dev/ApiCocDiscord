...
# Opcional: canal donde se anuncia el resultado + MVP apenas termina cada
# guerra (ver revisar_guerra en cogs/historial_guerras.py). Separado de
# CLAN_GAMES_CHANNEL_ID por si quieren canales distintos para cada aviso.
# Sin esto, simplemente no se anuncia nada (el guardado en la base sigue
# funcionando igual).
WAR_RESULT_CHANNEL_ID = os.getenv("WAR_RESULT_CHANNEL_ID") or None
